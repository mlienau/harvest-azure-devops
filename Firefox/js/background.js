(function() {
  ...
  PlatformExtension = (function() {
    ...
    PlatformExtension.prototype.version = browser.runtime.getManifest().version;
    ...
    function PlatformExtension() {
      ...
      // browser.webRequest.onHeadersReceived.addListener(this.handleHeaders, {
    ...
    PlatformExtension.prototype.getTimerStatus = function() {
      ...
      xhr.setRequestHeader("X-HarvestbrowserExt", this.version);
      return xhr.send();
    };
