(function () {
    ...
    injectScript = function (opts, nonce) {
        ...
        try {
            ...
            console.warn("ERROR INSERTING SCRIPT", opts, nonce);
        }
    };
    ...
    AzureDevOpsProfile = (function () {
        ...
        AzureDevOpsProfile.prototype.infect = function () {
            // window._harvestPlatformConfig = { applicationName: 'Azure DevOps' };
            injectScript("window._harvestPlatformConfig = { applicationName: 'Azure DevOps' };", "MDk1YTY5NmUtNDNkZS00OGFmLTg3NmUtMTlhZTM5YWI0MTRi");
            // injectScript({
    ...
    browser.runtime.sendMessage({ type: "getHost" }, function (host) {
